...
namespace EkkoMod.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "ekkoassetbundle";
        //change this to your project's name if/when you've renamed it
        private const string csProjName = "EkkoMod";
        ...
        {                                                                
            ...
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{csProjName}.EkkoBank.bnk"))
            {
