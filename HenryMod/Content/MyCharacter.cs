...
namespace EkkoMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            subtitleNameToken = EkkoPlugin.DEVELOPER_PREFIX + "_EKKO_BODY_SUBTITLE",
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(EkkoPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                //{
                //    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshEkkoSword"),
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(EkkoPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY_SKIN_NAME",
