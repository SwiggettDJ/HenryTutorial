...
namespace EkkoMod.SkillStates
{
    public class Chronobreak : BaseSkillState
    {
        ...
        {
            base.OnEnter();
            this.duration = Chronobreak.baseDuration / this.attackSpeedStat;
        ...
        private void Fire()
        {
            ...
            {
                this.hasFired = true;
                Util.PlaySound("EkkoBombThrow", base.gameObject);
                ...
                if (base.isAuthority)
                {
                    ...
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.bombPrefab, 
                        ...
                        base.gameObject, 
                        Chronobreak.damageCoefficient * this.damageStat, 
                        4000f, 
                        base.RollCrit(), 
                        DamageColorIndex.Default, 
                        null, 
                        Chronobreak.throwForce);
                }
            }
        }
